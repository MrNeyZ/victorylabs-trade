...
| `GET /api/signals/recent?lookbackMinutes=&minSmartScore=&limit=` | Smart Money Signals computed live over a recent trade window (not persisted). See [`docs/smart-money-signals.md`](./docs/smart-money-signals.md).                                                                                                                         |
